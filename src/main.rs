...
fn main() {
    let ivory = Material::new((0.6, 0.3), Vec3::new(0.4, 0.4, 0.3), 50.0);
    let red_rubber = Material::new((0.9, 0.1),Vec3::new(0.3, 0.1, 0.1), 10.0);
    ...
    image_matrix.save_image("test5.png");
}
